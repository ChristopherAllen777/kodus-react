...
export default class PropertyShortDescription extends MyComponent {
        ...
        return (
            <div style= { { backgroundColor: 'white', padding: '10px' } } id="listing-bin" className="row">
                ...
                <div className="col-md-4">
                    ...
                    <hr/>
                    <p>Phone |  {this.props.property_object.phone_number}</p>
                    <p>Email |  {this.props.property_object.email}</p>
                </div>
